...
//
//public class SearchCargoStepDefinitions extends BasicStepDefinition {
//
//    private boolean testPassed;
//    private static int scenarioCounter = 0; // Contador de escenarios
//
//    @Given("el usuario está en la página de búsqueda de cargos")
//    public void elUsuarioEstaEnLaPaginaDeBusquedaDeCargos() {
//        createPDF("BusquedaCargos");
//        addText("Inicio de prueba: el usuario está en la página de búsqueda de cargos");
//        driver.manage().window().maximize();
//        driver.get("http://localhost:3000/SearchCargo");
