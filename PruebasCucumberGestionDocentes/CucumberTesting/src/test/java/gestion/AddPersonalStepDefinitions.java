...
//
//public class AddPersonalStepDefinitions extends BasicStepDefinition {
//
...
//
//        captureScreenShot();
//        // WebElement addButton = driver.findElement(By.xpath("//button[text()='Agregar Docente']"));
//        // addButton.click();
//    }
//
...
//
//        try {
//            if (resultadoEsperado.equals("Docente agregado correctamente")) {
//                WebElement successMessage = driver.findElement(By.xpath("//div[text()='Docente agregado correctamente']"));
//                assertEquals("Docente agregado correctamente", successMessage.getText().trim());
//                addText("Prueba correcta: El docente fue agregado correctamente");
