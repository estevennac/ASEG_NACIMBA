...
public class SearchPersonalFailStepDefinitions extends BasicStepDefinition {
    ...
    public void elUsuarioEstaEnLaPaginaDeBusquedaDePersonal() {
        createPDF("BusquedaPersonalFailure");
        addText("Inicio de prueba: el usuario está en la página de búsqueda de personal");
        driver.manage().window().maximize();
        driver.get("http://localhost:3000/SearchPersonal");
    ...
    public void elSistemaDebeMostrar(String expectedResult) {
        ...
        // Verificación correcta del resultado esperado
    ...
    public void tearDown() {
        if (scenarioCounter == 1 || scenarioCounter == 3) { // Escenarios esperados fallidos
            addText("Prueba fallida: No se encontraron resultados");
        } else if (testPassed) {
        ...
        closePDF();
        if (driver != null) {
            driver.quit(); // Cierra el WebDriver completamente
        }
    }
}
